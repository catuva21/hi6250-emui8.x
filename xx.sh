...
case $ch in
  ...
  2) echo -e "$cyan***********************************************"
     ...
     rm -rf ../out
cp -r ~/Escritorio/Akernels/Files/libperl.a drivers/huawei_platform/lcd/tools/localperl/lib/5.14.2/x86_64-linux-thread-multi/CORE/libperl.a
     cp -r ~/Escritorio/Akernels/Files/zconf.hash.c scripts/kconfig/zconf.hash.c
     cp -r ~/Escritorio/Akernels/Files/zconf.lex.c scripts/kconfig/zconf.lex.c
     cp -r ~/Escritorio/Akernels/Files/zconf.tab.c scripts/kconfig/zconf.tab.c
	 make_kernel ;;
esac
